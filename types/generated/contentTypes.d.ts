...
export interface ApiLessionLession extends Schema.CollectionType {
  ...
  attributes: {
    LessionName: Attribute.String;
    LessionType: Attribute.String;
...
export interface ApiUserLessionUserLession extends Schema.CollectionType {
  collectionName: 'user_lessions';
  info: {
    singularName: 'user-lession';
    pluralName: 'user-lessions';
    displayName: 'UserLession';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    User: Attribute.Relation<
      'api::user-lession.user-lession',
      'oneToOne',
      'plugin::users-permissions.user'
    >;
    Lession: Attribute.Relation<
      'api::user-lession.user-lession',
      'oneToOne',
      'api::lession.lession'
    >;
    IsCompleted: Attribute.Integer;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::user-lession.user-lession': ApiUserLessionUserLession;
